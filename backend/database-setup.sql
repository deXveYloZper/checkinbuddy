-- CheckInBuddy Database Setup Script
-- Based on DEVELOPMENT.md schema specification
...
-- Create ENUM types
CREATE TYPE user_role AS ENUM ('host', 'agent');
CREATE TYPE verification_status AS ENUM ('pending', 'verified', 'rejected');
CREATE TYPE check_in_status AS ENUM ('pending', 'accepted', 'in_progress', 'completed', 'cancelled_host', 'cancelled_agent', 'expired');
...
-- INSERT INTO users (email, role, name, phone, firebase_uid) VALUES 
-- ('host@example.com', 'host', 'Test Host', '+390123456789', 'firebase_uid_host'),
-- ('agent@example.com', 'agent', 'Test Agent', '+390987654321', 'firebase_uid_agent');
